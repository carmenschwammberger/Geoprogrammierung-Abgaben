...
class MyWindow(QMainWindow):
    ...
    def createLayout(self):
        ...
        filemenu2.addAction("Karte", self.Karte)
...
# Zuvor gespeicherter Datensatz laden (Aufgabe 1c)
    def laden(self):
        filename, type = QFileDialog.getOpenFileName(self, "Datei öffnen","","Textfile (*.txt)")
